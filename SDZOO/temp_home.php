...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
  ...
  <body>
	    ...
	    <div class="tabbable"> <!-- Only required for left/right tabs -->
    			...
    			<div class="tab-pane" id="tab2">
    				...
    				<div class ="span3">				
            			...
            			<input type="text" id="AnimalSpecies" class="span3 input-medium search-query" placeholder ="Animal Species" style="margin: 0 auto;" data-provide="typeahead" data-items="4" data-source='[<?php 
							$animal_list = mysql_query("SELECT species_name FROM animal_species");
    		...
    		<div class="tab-pane" id="tab3">
				...
				<?php
					...
					$date_offset = $date-$two_weeks; 
					$query = "SELECT * FROM enrichment_animal WHERE zookeeper_id = $user AND $date > $date_offset";
	...
	$("#viewAnimalFromSpecies").click(function(){
